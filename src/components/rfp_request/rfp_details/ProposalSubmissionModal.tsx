    ...
    <div className="w-full h-full flex flex-col" >
      ...
      >
        <div className="bg-white w-full pt-3 pl-3 mb-[8px]">
          <div>
            <span className="font-bold text-[22px] leading-[33.8px] mb-[8px] block">{"Aufait"}</span>
            <span className="mb-[4px] block" style={{ color: "gray", fontSize: "14px" }}>Malappuuram, Kerala</span>
            <span style={{ padding: "4px 8px", border: "1px solid #A8AEBA", borderRadius: "20px", fontSize: "14px", backgroundColor: "#EBEEF4" }}>ID: {"VENDORID"}</span>
          </div>
        </div>
        <div className="p-4 rounded">
          <div className="mb-2">
            <KeyValueGrid className="mb-[16px]"
              data={[
                { label: "Bid Amount", value: "$2000" },
                { label: "Bid Validity", value: "30 days" },
              ]}
            />
            <KeyValueGrid className="mb-[16px]"
              data={[
                { label: "Tax Included", value: "Yes" },
                { label: "Included Delivery/Logistics", value: "Yes" },
              ]}
            />
            {/* Payment Terms */}
            <div className="mb-[16px]" style={{ width: "504px" }}>
              <span className="mb-[4px]" style={{ color: "gray", fontSize: "12px" }}>Payment Terms</span>
              <p className="text-sm whitespace-pre-wrap break-words leading-relaxed">{`40% payable within 7 days of PO issuance
Remaining 60% upon successful delivery and client sign-off`}</p>
            </div>

            {/* Description */}
            <div className="mb-[16px]" style={{ width: "504px" }}>
              <span className="mb-[4px]" style={{ color: "gray", fontSize: "12px" }}>Escalation Clause / Price Revisions</span>
              <p className="text-sm whitespace-pre-wrap break-words leading-relaxed">{`Prices are fixed for the 90-day bid validity period. 
Post that, a maximum 5% upward revision may be applicable 
if raw material or licensing costs increase significantly.
