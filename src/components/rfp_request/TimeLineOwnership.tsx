  ...
  return (
    <div className="p-2 w-[484px]">
      ...
      <div className="mb-4">
        ...
        <TextField
          id="technicalOwners"
          field="technicalOwners"
          value={requestData.technicalOwners || ""} // Bind value from state
          setValue={(value) =>
            setRequestData((prev: any) => ({ ...prev, technicalOwners: [...prev.technicalOwners,value] }))
          } // Update only projectDescription
          placeholder="Add Technical Owners"
          style=""
          type="textarea"
          width="w-full"
        />
      ...
      <div className="mb-4">
        ...
        <TextField
          id="technicalOwners"
          field="technicalOwners"
          value={requestData.commercialOwners || ""} // Bind value from state
          setValue={(value) =>
            setRequestData((prev: any) => ({ ...prev, commercialOwners: [...prev.commercialOwners,value] }))
          } // Update only projectDescription
          placeholder="Add Commercial Owners"
          style=""
          type="textarea"
          width="w-full"
        />
